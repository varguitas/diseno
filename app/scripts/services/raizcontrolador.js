...
/**
 * @ngdoc service
 * @name proyectodisenoApp.RaizControlador
 * @description
 * # RaizControlador
 * Service in the proyectodisenoApp.
 */
angular.module('proyectodisenoApp')
  .service('RaizControlador', function () {
    function RaizControlador($scope,$http) {
    	this.$scope = $scope;
    	this.$http = $http;
    }
    RaizControlador.prototype.operate = function () {
    	var _self = this;
		this.$http.post('/raiz', {operacionDTO: _self.$scope.structure}).
